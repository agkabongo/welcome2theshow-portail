...
const initialMilestones = [
  {
    ...
    date: "2024-06-15",
    description: "Released debut album 'New Beginnings'",
    category: "release",
  },
  {
    id: 2,
    title: "Sold Out Show",
    date: "2024-08-20",
    description: "First sold-out performance at MSG",
  ...
  },
  {
    ...
    date: "2024-12-01",
    description: "Won 'Best New Artist'",
    category: "award",
  },
];
...
const initialTasks = [
  ...
  {
    id: 3,
    title: "Contact venue management",
    completed: false,
              ...
              <div className="mb-2">
                <span
                  className={cn(
                    ...
                    upcomingMilestone.category === "release" &&
                      "bg-blue-100 text-blue-700",
                    upcomingMilestone.category === "performance" &&
                      "bg-green-100 text-green-700",
                    upcomingMilestone.category === "award" &&
                    ...
                    <span
                      className={cn(
                        ...
                        milestone.category === "release" &&
                          "bg-blue-100 text-blue-700",
                        milestone.category === "performance" &&
                          "bg-green-100 text-green-700",
